...
module.exports = function(req, res) {
    rules.checkPoints(function(err, rules) {
        ...
        var data = {
            ...
            {providerName: "Socal Edison", description: "Insider Deal: 10% off your next billing period", requirements: "Ensure windows and exterior doors are closed when using your HVAC system", value: rules.windowRule},
