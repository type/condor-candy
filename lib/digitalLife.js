...
function DL(userId, appKey) {
    ...
    this.setDeviceAttribute = function(deviceGUID, attribute, value, callback) {
        var self = this;
    ...
    this.getDeviceAttribute = function(deviceGUID, attribute, callback) {
        var self = this;
...
var dl = new DL('553474464', 'KE_3339472F04964023_1');


dl.events(function(err, results){
